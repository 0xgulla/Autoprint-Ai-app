      ...
      <div className="detail-grid">
        <Card title="Job timeline">
          <div className="tracking-status">
            <span
              className={
                "tracking-icon " + (j.status === "Completed" ? "green" : "blue")
              }
            >
              <Printer size={34} />
            </span>
            ...
            <p>
              {j.status === "Completed"
                ? "Demo printing completed successfully. No physical pages were printed."
                : j.status === "Paused"
                  ? "This job is paused. Resume it from the print queue."
                  : position
                    ? `Queue position ${position} · About ${Math.max(1, position) * 28} seconds in simulation.`
                    : "Review your job details below."}
            </p>
          </div>
