...
export default function NewPrint() {
  ...
  async function useSample() {
    try {
      setBusy(true);
      const r = await fetch("/api/sample.pdf");
      if (!r.ok) throw new Error("Could not load the sample PDF.");
      const b = await r.blob();
      await loadFile(
        new File([b], "AutoPrint_Sample.pdf", { type: "application/pdf" }),
      );
    } catch (e) {
      setError(e.message);
      setBusy(false);
            ...
            >
              ...
              <div className="sample-row">
                ...
                <div>
                  ...
                  <span>Try a sample with color content and a blank page.</span>
                </div>
                <button
                  ...
                  onClick={useSample}
                >
                  Use sample PDF <ArrowRight size={16} />
                </button>
              </div>
          ...
          {step === 2 && a && (
            ...
            >
              <div className="form-grid">
                ...
                <Field label="Pages per printed side">
                  <select
                    value={settings.nup}
                    onChange={(e) => update("nup", Number(e.target.value))}
                  >
            ...
            >
              ...
              <dl className="review-list">
                {[
                  ...
                  ["Layout", settings.nup + " page(s) per side"],
              ...
              <div className="test-payment-info">
                ...
                <div>
                  ...
                  <p>
                    ...
                    UPI ID, card details, or banking app is needed.
                  </p>
                </div>
              </div>
              <button
